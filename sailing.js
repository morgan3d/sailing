...
.md h1 {text-align: left; font-size: 35px}
.md div.subtitle {text-align: left; font-style: italic}
.md h1, .md h2, .md .nonumberh2, .md h3, .md .nonumberh3, .md h4, .md h5, .md h6 {font-family: header}
.md h2, .md .nonumberh2 {font-size: 30px}
.md h3, .md .nonumberh3 {font-size: 26px}
.md h4, .md .nonumberh4 {font-size: 24px}
.md h5, .md .nonumberh5 {font-size: 22px}
.md {line-height: 175%; color: #333; font-family: Georgia}
.md a {font-family: Georgia}
</style>
<style class="fallback">body{visibility:hidden}</style>`);

// The renderer replaces the body content when it runs, so the footer is
// appended afterward through the onLoad hook to land at the end of the
// rendered document. Documents set their own markdeepOptions before this
// script loads; merge rather than replace.
...
<br>
<br>&copy; 2022-2026 <a href="https://casual-effects.com">Morgan McGuire</a>.
...
document.write('<script src="' + baseURL + '/markdeep2.min.js" charset="utf-8"><\/script>');
